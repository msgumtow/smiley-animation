 ...
 * PART 2:
 * 
 * Now you'll code the four LEDs that are different to switch back and forth, using "toggle" blocks.
 * 
 ...
 * PART 1:
 * 
 * Plot the coordinates of only the LEDs that are the SAME in both the smiley and straight faced images.
 * 
 * <---Use these as only a reference - do not put them in "on start"
 * 
